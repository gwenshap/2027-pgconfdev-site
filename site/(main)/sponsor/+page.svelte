...
<header class="(main)">
  ...
  <p class="lede mute text">
    PGConf.dev is non-profit. Tickets alone don't cover are costs.
    Sponsors help cover the venue, A/V, catering, scholarships, and more.
  </p>
</header>
...
<section id="become" class="main">
  ...
  <p>
    ...
    scholarship program (travel grants for speakers and contributors who couldn't otherwise
    attend).
  </p>
</section>
...
>
  <div class="(main)">
    <hgroup class="h1">
      <p><a style:color="var(--bg)" href="https://2026.pgconf.dev">Past editions</a></p>
